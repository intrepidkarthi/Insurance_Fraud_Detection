...
plt.savefig('./img/myfilename.png')
##plt.show()
...
##plt.show()
plt.savefig('./img/NameDistribution.png')
...
#plt.show()
plt.savefig('./img/Gender Frequency.png')
...
#plt.show()
plt.savefig('./img/Marry Frequency.png')
...
#plt.show()
plt.savefig('./img/Claim VS Insured for 2000.png')
...
#plt.show()
plt.savefig('./img/Gender VS Age.png')
...
#plt.show()
plt.savefig('./img/Freq Age.png')


#### Number of payout per year
df.groupby('Fraudulent_Claim')['Claim_Amount'].sum().plot(kind='pie', title='Claim amount for fraud and not fraud', legend=True)
#plt.show()
plt.savefig('./img/Claim T&F.png')

df.groupby('Fraudulent_Claim')['Date_Of_Claim'].count().plot(kind='pie', title='Claim amount per year', legend=True)
#plt.show()
plt.savefig('./img/Total Count Claim amount per year.png')


#### Sum payouts year
df.groupby('Date_Of_Claim')['Claim_Amount'].sum().plot(kind='line', title='Claim amount per year', legend=True)
#plt.show()
plt.savefig('./img/Total Sum Claim per year.png')
